...
int main()
{
  ...
  Shader ourShader("./src/18_basic_lightmodel/shader/vertex.glsl", "./src/18_basic_lightmodel/shader/fragment.glsl");
  Shader lightShader("./src/18_basic_lightmodel/shader/light_vertex.glsl", "./src/18_basic_lightmodel/shader/light_fragment.glsl");
  ...
  ourShader.setFloat("ambientLightIntensity",0.1);

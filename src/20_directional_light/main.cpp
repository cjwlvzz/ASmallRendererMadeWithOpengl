...
int main()
{
  ...
  Shader ourShader("./src/20_directional_light/shader/vertex.glsl", "./src/20_directional_light/shader/fragment.glsl");
  Shader lightShader("./src/20_directional_light/shader/light_vertex.glsl", "./src/20_directional_light/shader/light_fragment.glsl");

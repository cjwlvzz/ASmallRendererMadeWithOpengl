...
int main()
{
  ...
  Shader ourShader("./src/22_spot_light/shader/vertex.glsl", "./src/22_spot_light/shader/fragment.glsl");
  Shader lightShader("./src/22_spot_light/shader/light_vertex.glsl", "./src/22_spot_light/shader/light_fragment.glsl");
  ...
  //-----------------Directional light-----------------
  ourShader.setVec3("directional.ambient", 0.01f, 0.01f, 0.01f);
  ourShader.setVec3("directional.diffuse", 0.2f, 0.2f, 0.2f);
  ourShader.setVec3("directional.specular", 1.0f, 1.0f, 1.0f);
